...
#           best_regression_model = compare_regression()
#           finalize_reg(best_regression_model)
#           evaluate_reg(best_regression_model)
#           prediction_reg = predict_reg(best_regression_model, data=df)
#           st.write(best_regression_model)
#           st.title("Model Prediction (Regression)")
#           st.write(prediction_reg)
#           st.table(best_regression_model)
# 
#         elif target_dtype == 'object':
#           classification = set_class(df, target=target_column, fold_strategy='stratifiedkfold')
#           best_classification_model = compare_classification()
#           finalize_class(best_classification_model)
#           evaluate_class(best_classification_model)
#           prediction_class = predict_class(best_classification_model, data=df)
#           st.write(best_classification_model)
#           st.title("Model Prediction (Classification)")
#           st.write(prediction_class)
#           st.table(best_classification_model)
#

! streamlit run PyCaret2.py & npx localtunnel --port 8501
